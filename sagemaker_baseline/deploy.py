"""Deploy bigram baseline model to SageMaker."""
...
MODEL_DATA = "s3://vectorworks-analytics-datalake/tool-rec-data/sagemaker/baseline_model.tar.gz"
ROLE = "arn:aws:iam::167665646931:role/tools-rec-iam-role"
ENDPOINT_NAME = "bim-command-rec-baseline"
MODEL_NAME = "bim-command-rec-baseline"
